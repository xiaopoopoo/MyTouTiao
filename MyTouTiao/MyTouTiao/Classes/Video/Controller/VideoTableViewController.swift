...
//        var identifier: String { return "\(self)" }//实现分类的方法，返回类的名字字符串
//        var nib: UINib? { return UINib(nibName: "\(self)", bundle: nil) }//返回该类的NIB
//        if let nib = nib {
//            tableView.register(nib, forCellReuseIdentifier:identifier)
//        }else {
//            tableView.register(VideoCell.self, forCellReuseIdentifier:identifier)
//        }
    }
}
